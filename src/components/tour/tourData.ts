...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Candidates are grouped into five tiers: Ready (100%), Near Ready (90–99%), Progressing (70–89%), Developing (50–69%), and Building (<50%). The breakdown per department shows how deep the succession bench is and how long it will take to fill roles organically.',
  ...
  },
  {
    ...
    view: 'pipeline-dept',
    title: 'Tier Columns',
    body: 'Five columns — Ready, Near Ready, Progressing, Developing, and Building — show every candidate ranked by readiness within their tier. The card displays their readiness bar, how many promotion criteria they\'ve met, location, and time in role. Click any card to open the full individual breakdown.',
