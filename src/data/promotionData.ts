...
export const PEOPLE: Person[] = [
  ...
  { id: 's4', name: 'Lila Osei', department: 'Sales', team: 'SMB', location: 'Remote', currentLevelId: 'sal-ic2', tenure: 8, lastCheckIn: '2026-02-10', skills: { 'negotiation': 2, 'demo': 3, 'account-mgmt': 2, 'forecasting': 2, 'executive': 1 }, inferredSkills: { 'comp-bench': 5, 'org-design': 4, 'change-mgmt': 4, 'dei': 5, 'hr-analytics': 4, 'perf-frameworks': 5 }, inferredNotes: [{ skillId: 'comp-bench', source: 'HR Generalist at Goldman Sachs for 3 years before Sales', confidence: 'high' }, { skillId: 'dei', source: 'Co-founded DEI working group at Goldman; CIPD Level 5 qualified', confidence: 'high' }, { skillId: 'perf-frameworks', source: 'Designed performance calibration framework for 200-person team', confidence: 'medium' }], linkedInSignals: ['CIPD Level 5 qualified', 'HR Generalist · Goldman Sachs (3 yrs)', 'Account Executive · Acme (current)'] },
