...
export const ATTRITION_RECORDS: AttritionRecord[] = [
  { date: '2026-04-15', name: 'Jordan Lee',       department: 'Engineering',  level: 'IC3', destination: 'Stripe',          destinationType: 'Big Tech',   reason: 'compensation',   tenureMonths: 28, monthsSinceLastCheckIn: 94,  monthsAtLevel: 26, skillStagnant: true,  inferredPayGapPct: 22, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2026-04-02', name: 'Sam Rivera',        department: 'Product',      level: 'IC2', destination: 'Notion',          destinationType: 'Scaleup',    reason: 'career-growth',  tenureMonths: 14, monthsSinceLastCheckIn: 41,  monthsAtLevel: 14, skillStagnant: false, inferredPayGapPct: 8,  hadRecentPromotion: false, recentManagerChange: true  },
  { date: '2026-03-20', name: 'Taylor Kim',        department: 'Engineering',  level: 'IC4', destination: 'Google',          destinationType: 'Big Tech',   reason: 'compensation',   tenureMonths: 36, monthsSinceLastCheckIn: 112, monthsAtLevel: 31, skillStagnant: true,  inferredPayGapPct: 31, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2026-03-11', name: 'Alex Morgan',       department: 'Data',         level: 'IC2', destination: 'Snowflake',        destinationType: 'Enterprise', reason: 'career-growth',  tenureMonths: 19, monthsSinceLastCheckIn: 58,  monthsAtLevel: 19, skillStagnant: false, inferredPayGapPct: 12, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2026-02-28', name: 'Casey Brown',       department: 'Marketing',    level: 'IC3', destination: 'HubSpot',          destinationType: 'Enterprise', reason: 'compensation',   tenureMonths: 22, monthsSinceLastCheckIn: 77,  monthsAtLevel: 22, skillStagnant: true,  inferredPayGapPct: 18, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2026-02-14', name: 'Riley Chen',        department: 'Engineering',  level: 'IC3', destination: 'Stripe',          destinationType: 'Big Tech',   reason: 'compensation',   tenureMonths: 31, monthsSinceLastCheckIn: 103, monthsAtLevel: 28, skillStagnant: true,  inferredPayGapPct: 25, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2026-01-31', name: 'Morgan Davis',      department: 'Design',       level: 'IC2', destination: 'Figma',           destinationType: 'Scaleup',    reason: 'career-growth',  tenureMonths: 11, monthsSinceLastCheckIn: 18,  monthsAtLevel: 11, skillStagnant: false, inferredPayGapPct: 6,  hadRecentPromotion: false, recentManagerChange: true  },
  { date: '2026-01-20', name: 'Drew Wilson',       department: 'Sales',        level: 'IC2', destination: 'Ripple Analytics', destinationType: 'Competitor', reason: 'compensation',   tenureMonths: 16, monthsSinceLastCheckIn: 52,  monthsAtLevel: 16, skillStagnant: false, inferredPayGapPct: 14, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2026-01-08', name: 'Quinn Martinez',    department: 'Engineering',  level: 'IC2', destination: 'Vercel',          destinationType: 'Scaleup',    reason: 'career-growth',  tenureMonths: 10, monthsSinceLastCheckIn: 9,   monthsAtLevel: 10, skillStagnant: false, inferredPayGapPct: 10, hadRecentPromotion: false, recentManagerChange: true  },
  { date: '2025-12-19', name: 'Avery Johnson',     department: 'Product',      level: 'IC3', destination: 'Linear',          destinationType: 'Startup',    reason: 'culture',        tenureMonths: 24, monthsSinceLastCheckIn: 88,  monthsAtLevel: 24, skillStagnant: true,  inferredPayGapPct: 3,  hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-12-05', name: 'Blake Thompson',    department: 'Data',         level: 'IC3', destination: 'Databricks',      destinationType: 'Enterprise', reason: 'career-growth',  tenureMonths: 27, monthsSinceLastCheckIn: 95,  monthsAtLevel: 27, skillStagnant: true,  inferredPayGapPct: 17, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-11-22', name: 'Charlie White',     department: 'Engineering',  level: 'IC3', destination: 'Google',          destinationType: 'Big Tech',   reason: 'compensation',   tenureMonths: 33, monthsSinceLastCheckIn: 120, monthsAtLevel: 30, skillStagnant: true,  inferredPayGapPct: 28, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-11-10', name: 'Dana Garcia',       department: 'People Ops',   level: 'IC2', destination: 'Workday',          destinationType: 'Enterprise', reason: 'career-growth',  tenureMonths: 18, monthsSinceLastCheckIn: 34,  monthsAtLevel: 18, skillStagnant: false, inferredPayGapPct: 9,  hadRecentPromotion: false, recentManagerChange: true  },
  { date: '2025-10-29', name: 'Elliot Harris',     department: 'Marketing',    level: 'IC2', destination: 'Mailchimp',       destinationType: 'Enterprise', reason: 'compensation',   tenureMonths: 13, monthsSinceLastCheckIn: 44,  monthsAtLevel: 13, skillStagnant: false, inferredPayGapPct: 11, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-10-14', name: 'Finley Clark',      department: 'Engineering',  level: 'IC4', destination: 'Meta',            destinationType: 'Big Tech',   reason: 'compensation',   tenureMonths: 41, monthsSinceLastCheckIn: 135, monthsAtLevel: 38, skillStagnant: true,  inferredPayGapPct: 34, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-09-30', name: 'Gray Lewis',        department: 'Design',       level: 'IC3', destination: 'Figma',           destinationType: 'Scaleup',    reason: 'career-growth',  tenureMonths: 20, monthsSinceLastCheckIn: 61,  monthsAtLevel: 20, skillStagnant: false, inferredPayGapPct: 8,  hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-09-17', name: 'Harper Robinson',   department: 'Sales',        level: 'IC3', destination: 'Verity HQ',       destinationType: 'Competitor', reason: 'compensation',   tenureMonths: 25, monthsSinceLastCheckIn: 83,  monthsAtLevel: 25, skillStagnant: true,  inferredPayGapPct: 16, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-09-03', name: 'Indigo Walker',     department: 'Engineering',  level: 'IC2', destination: 'Vercel',          destinationType: 'Scaleup',    reason: 'career-growth',  tenureMonths: 9,  monthsSinceLastCheckIn: null, monthsAtLevel: 9,  skillStagnant: false, inferredPayGapPct: 12, hadRecentPromotion: false, recentManagerChange: true  },
  { date: '2025-08-20', name: 'Jules Hall',        department: 'Data',         level: 'IC2', destination: 'Snowflake',        destinationType: 'Enterprise', reason: 'career-growth',  tenureMonths: 15, monthsSinceLastCheckIn: 27,  monthsAtLevel: 15, skillStagnant: false, inferredPayGapPct: 10, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-08-07', name: 'Kit Young',         department: 'Product',      level: 'IC2', destination: 'Loom',            destinationType: 'Startup',    reason: 'culture',        tenureMonths: 12, monthsSinceLastCheckIn: 14,  monthsAtLevel: 12, skillStagnant: false, inferredPayGapPct: 2,  hadRecentPromotion: false, recentManagerChange: true  },
  { date: '2025-07-25', name: 'Lane Allen',        department: 'Engineering',  level: 'IC3', destination: 'Stripe',          destinationType: 'Big Tech',   reason: 'compensation',   tenureMonths: 29, monthsSinceLastCheckIn: 98,  monthsAtLevel: 26, skillStagnant: true,  inferredPayGapPct: 23, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-07-11', name: 'Marlowe Scott',     department: 'Marketing',    level: 'IC3', destination: 'HubSpot',          destinationType: 'Enterprise', reason: 'compensation',   tenureMonths: 21, monthsSinceLastCheckIn: 71,  monthsAtLevel: 21, skillStagnant: true,  inferredPayGapPct: 15, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-06-28', name: 'Nico King',         department: 'Engineering',  level: 'IC2', destination: 'Notion',          destinationType: 'Scaleup',    reason: 'culture',        tenureMonths: 8,  monthsSinceLastCheckIn: 7,   monthsAtLevel: 8,  skillStagnant: false, inferredPayGapPct: 5,  hadRecentPromotion: false, recentManagerChange: true  },
  { date: '2025-06-14', name: 'Onyx Wright',       department: 'Design',       level: 'IC2', destination: 'Unknown',          destinationType: 'Unknown',    reason: 'unknown',        tenureMonths: 14, monthsSinceLastCheckIn: null, monthsAtLevel: 14, skillStagnant: false, inferredPayGapPct: undefined, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-05-30', name: 'Parker Green',      department: 'Sales',        level: 'IC2', destination: 'Ripple Analytics', destinationType: 'Competitor', reason: 'compensation',   tenureMonths: 17, monthsSinceLastCheckIn: 55,  monthsAtLevel: 17, skillStagnant: false, inferredPayGapPct: 13, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-05-16', name: 'Quinn Adams',       department: 'Engineering',  level: 'IC3', destination: 'Google',          destinationType: 'Big Tech',   reason: 'compensation',   tenureMonths: 34, monthsSinceLastCheckIn: 116, monthsAtLevel: 31, skillStagnant: true,  inferredPayGapPct: 29, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-05-02', name: 'Remy Baker',        department: 'Data',         level: 'IC3', destination: 'Databricks',      destinationType: 'Enterprise', reason: 'career-growth',  tenureMonths: 30, monthsSinceLastCheckIn: 101, monthsAtLevel: 30, skillStagnant: true,  inferredPayGapPct: 18, hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-04-18', name: 'Sage Nelson',       department: 'Product',      level: 'IC3', destination: 'Linear',          destinationType: 'Startup',    reason: 'career-growth',  tenureMonths: 22, monthsSinceLastCheckIn: 79,  monthsAtLevel: 22, skillStagnant: false, inferredPayGapPct: 4,  hadRecentPromotion: false, recentManagerChange: false },
  { date: '2025-04-04', name: 'Tatum Carter',      department: 'Engineering',  level: 'IC2', destination: 'Vercel',          destinationType: 'Scaleup',    reason: 'career-growth',  tenureMonths: 11, monthsSinceLastCheckIn: 12,  monthsAtLevel: 11, skillStagnant: false, inferredPayGapPct: 9,  hadRecentPromotion: false, recentManagerChange: true  },
  { date: '2025-03-21', name: 'Uma Mitchell',      department: 'People Ops',   level: 'IC3', destination: 'Workday',          destinationType: 'Enterprise', reason: 'compensation',   tenureMonths: 26, monthsSinceLastCheckIn: 87,  monthsAtLevel: 26, skillStagnant: true,  inferredPayGapPct: 14, hadRecentPromotion: false, recentManagerChange: false },
];
