...
function TourNudge({ onDismiss }: { onDismiss: () => void }) {
  ...
  return (
    <div className="absolute top-full right-0 mt-2 w-52 bg-gray-900 border border-amber-500/30 rounded-xl shadow-xl p-3 z-[300]">
      <div className="absolute -top-1.5 right-5 w-3 h-3 bg-gray-900 border-l border-t border-amber-500/30 rotate-45" />
      <p className="text-xs text-amber-300 font-semibold mb-1">New to Progression?</p>
