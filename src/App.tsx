...
import { LayoutGrid, TrendingUp, Sparkles, BarChart3, Globe, Home, ArrowLeft, BookOpen, HelpCircle, Layers } from 'lucide-react';
...
type ActiveView = 'home' | 'heatmap' | 'pipeline' | 'managers' | 'benchmark' | 'ask-ai' | 'how-it-works' | 'gap-report' | 'zero-states';
